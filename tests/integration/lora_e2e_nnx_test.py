...
class LoraE2ENnxIntegrationTest(unittest.TestCase):
  ...
  def _run_e2e_flow(self, model_name, use_sft, lora_weight_qtype=None):
  ...
  def _run_e2e_flow_sft(self, model_name, lora_weight_qtype=None):
