...
SCANNED_CKPT_PATH=gs://maxtext-deepseek/deepseek4-284b/2026-07-24/scanned/0/items
UNSCANNED_CKPT_PATH=gs://maxtext-deepseek/deepseek4-284b/2026-07-24/unscanned/0/items
...
if [ ! -f "${GOLDEN_LOGITS_DISK_LOCATION}" ]; then
  GOLDEN_LOGITS_PATH="gs://maxtext-test-assets/golden_data_deepseek4-284b.jsonl"
