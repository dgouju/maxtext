...
- **Notes**: MLA; shared/finer-grained experts; MTP; YaRN-style scaling; DeepSeek Sparse Attention (V3.2); Heavily compressed attention + compressed sparse attention + manifold-constrained hyperconnections (V4).
